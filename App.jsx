  ...
  {editingPreferredName ? (
    ...
    <>
      ...
      {(profile.role === 'counselor' || profile.role === 'case_manager' || profile.role === 'admin') && (
        <button
          onClick={() => {
            setPreferredNameInput(selectedStudent.preferred_name || '');
      ...
      {inviteParentSuccess ? (
        <div className="text-center py-6">
          ...
          <p className="text-slate-400 text-sm mt-2">
            {inviteParentEmail} will receive an email to create their GradTrack parent account.
        ...
        <>
          <p className="text-slate-400 text-sm mb-4">
            Enter the parent's email address. They'll receive an invitation to create a GradTrack account
